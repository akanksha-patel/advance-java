...
public class User{
	...
	public boolean registerUser(){
		...
		try{
			...
			String query = "insert into users (user_name,email,password,gender_id,city_id,activation_code,pic_path) value (?,?,?,?,?,?,?)";
	...
	public boolean loginUser(){
		...
		try{
			...
			String query = "select password,user_id,user_name,gender_id,city_id,user_type_id,activation_status,pic_path from users where email=?";
			PreparedStatement ps = connection.prepareStatement(query);
	...
	public boolean updatePicPath(String picPath){
		boolean flag = false;
